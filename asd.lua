...
library.theme = {
    ...
    accentcolor = Color3.fromRGB(255,147,245),
    accentcolor2 = Color3.fromRGB(156,197,245),
...
function library:CreateWatermark(name)
    ...
    watermark.mainbar.MouseEnter:Connect(
        function()
            tweenservice:Create(
                watermark.mainbar,
    ...
    watermark.mainbar.MouseLeave:Connect(
        function()
            tweenservice:Create(
                watermark.mainbar,
                TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In),
...
function library:CreateWindow(name, size, hidebutton)
    ...
    function window:CreateTab(name)
        ...
        tab.TabButton.MouseButton1Down:Connect(
            function()
                tab:SelectTab()
            end
        )
        ...
        function tab:CreateSector(name, side)
            ...
            sector.Main:GetPropertyChangedSignal("Size"):Connect(
                function()
                    sector.BlackOutline.Size = sector.Main.Size + UDim2.fromOffset(2, 2)
                end
            )
            ...
            sector.Label.Size =
                UDim2.fromOffset(
                math.clamp(
                    textservice:GetTextSize(sector.name, 13, window.theme.font, Vector2.new(200, 300)).X + 10,
                    0,
            ...
            function sector:FixSize()
                sector.Main.Size =
                    UDim2.fromOffset(window.size.X.Offset / 2 - 17, sector.ListLayout.AbsoluteContentSize.Y + 18)
                ...
                local extra =
                    sizeleft > sizeright and (#tab.SectorsLeft - 1) * tab.LeftListPadding.PaddingTop.Offset or
                    (#tab.SectorsRight - 1) * tab.RightListPadding.PaddingTop.Offset
            ...
            function sector:AddButton(text, callback)
                ...
                button.BlackOutline2.MouseEnter:Connect(
                    function()
                        button.BlackOutline2.BackgroundColor3 = window.theme.accentcolor
                    end
                )
                button.BlackOutline2.MouseLeave:Connect(
                    function()
                        button.BlackOutline2.BackgroundColor3 = window.theme.outlinecolor2
                    end
                )
            ...
            function sector:AddToggle(text, default, callback)
                ...
                function toggle:AddKeybind(default)
                    ...
                    keybind.Main.MouseButton1Down:Connect(
                        function()
                            keybind.Main.Text = "[...]"
                ...
                function toggle:AddColorpicker(default, callback)
                    ...
                    colorpicker.BlackOutline2.MouseEnter:Connect(
                        function()
                            colorpicker.BlackOutline2.BackgroundColor3 = window.theme.accentcolor
                        end
                    )
                    colorpicker.BlackOutline2.MouseLeave:Connect(
                        function()
                        ...
                        colorpicker.hueselectorpointer:TweenPosition(
                            UDim2.new(
                                math.clamp(
                                    ...
                                    0.5,
                                    0.945 * colorpicker.hue.AbsoluteSize.X
                                ) / colorpicker.hue.AbsoluteSize.X,
                                0,
                                math.clamp(
                                    y * colorpicker.hue.AbsoluteSize.Y,
                                    0.5,
                                    0.855 * colorpicker.hue.AbsoluteSize.Y
                    ...
                    function colorpicker:Set(value)
                        local color =
                            Color3.fromRGB(
                            tostring(math.floor(255 * value.r)),
                            tostring(math.floor(255 * value.g)),
                            tostring(math.floor(255 * value.b))
                        )
                        colorpicker.value = color

                        local clr = Color3.fromRGB(color.R - 30, color.G - 30, color.B - 30)
                        colorpicker.Gradient.Color =
                            ColorSequence.new(
                            {ColorSequenceKeypoint.new(0.00, color), ColorSequenceKeypoint.new(1.00, color)}
                        )
                    ...
                    colorpicker.selector.InputBegan:Connect(
                        function(input)
                    ...
                    colorpicker.selector.InputEnded:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseButton1 then
                    ...
                    colorpicker.hue.InputEnded:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseButton1 then
                                dragging_hue = false
                                colorpicker:RefreshHue()
                ...
                toggle.Main.MouseButton1Down:Connect(
                    function()
                        toggle:Set(not toggle.CheckedFrame.Visible)
                    end
                )
                toggle.Label.InputBegan:Connect(
                    function(input)
                        if input.UserInputType == Enum.UserInputType.MouseButton1 then
                            toggle:Set(not toggle.CheckedFrame.Visible)
                        end
            ...
            function sector:AddTextbox(text, default, callback)
                ...
                textbox.Main.FocusLost:Connect(
                    function()
                ...
                textbox.BlackOutline2.MouseEnter:Connect(
                    function()
                        textbox.BlackOutline2.BackgroundColor3 = window.theme.accentcolor
                    end
                )
                textbox.BlackOutline2.MouseLeave:Connect(
                    function()
                        textbox.BlackOutline2.BackgroundColor3 = window.theme.outlinecolor2
                    end
                )
            ...
            function sector:AddSlider(text, min, max, default, decimals, callback)
                ...
                slider.BlackOutline2.MouseEnter:Connect(
                    function()
                        slider.BlackOutline2.BackgroundColor3 = window.theme.accentcolor
                    end
                )
                slider.BlackOutline2.MouseLeave:Connect(
                    function()
                        slider.BlackOutline2.BackgroundColor3 = window.theme.outlinecolor2
                    end
                )
                ...
                slider.InputLabel.FocusLost:Connect(
                    function(Return)
                        if not Return then
                            return
                        end
                ...
                function slider:Refresh()
                    ...
                    local percent =
                        math.clamp(mousePos.X - slider.SlideBar.AbsolutePosition.X, 0, slider.Main.AbsoluteSize.X) /
                        slider.Main.AbsoluteSize.X
                    local value =
                        math.floor((slider.min + (slider.max - slider.min) * percent) * slider.decimals) /
                        slider.decimals
                    value = math.clamp(value, slider.min, slider.max)
                    slider:Set(value)
                end

                slider.SlideBar.InputBegan:Connect(
                    function(input)
                        if input.UserInputType == Enum.UserInputType.MouseButton1 then
                            dragging = true
                            slider:Refresh()
                ...
                slider.SlideBar.InputEnded:Connect(
                    function(input)
                        if input.UserInputType == Enum.UserInputType.MouseButton1 then
                            dragging = false
                        end
                ...
                slider.Main.InputBegan:Connect(
                    function(input)
                        if input.UserInputType == Enum.UserInputType.MouseButton1 then
                            dragging = true
                            slider:Refresh()
                ...
                slider.Main.InputEnded:Connect(
                    function(input)
                        if input.UserInputType == Enum.UserInputType.MouseButton1 then
                            dragging = false
                        end
            ...
            function sector:AddColorpicker(text, default, callback)
                ...
                colorpicker.Gradient.Color =
                    ColorSequence.new(
                    {ColorSequenceKeypoint.new(0.00, colorpicker.value), ColorSequenceKeypoint.new(1.00, clr)}
                )
                ...
                function colorpicker:RefreshHue()
                    ...
                    colorpicker.hueselectorpointer:TweenPosition(
                        UDim2.new(
                            math.clamp(x * colorpicker.hue.AbsoluteSize.X, 0.5, 0.945 * colorpicker.hue.AbsoluteSize.X) /
                                colorpicker.hue.AbsoluteSize.X,
                            0,
                            math.clamp(y * colorpicker.hue.AbsoluteSize.Y, 0.5, 0.855 * colorpicker.hue.AbsoluteSize.Y) /
                                colorpicker.hue.AbsoluteSize.Y,
                            0
                        ),
                        Enum.EasingDirection.In,
                    ...
                    colorpicker:Set(
                        Color3.fromHSV(
                            ...
                            math.clamp(x * colorpicker.hue.AbsoluteSize.X, 0.5, 1 * colorpicker.hue.AbsoluteSize.X) /
                                colorpicker.hue.AbsoluteSize.X,
                            1 -
                                (math.clamp(y * colorpicker.hue.AbsoluteSize.Y, 0.5, 1 * colorpicker.hue.AbsoluteSize.Y) /
                                    colorpicker.hue.AbsoluteSize.Y)
                        )
                    )
                end
                ...
                function colorpicker:Set(value)
                    ...
                    colorpicker.Gradient.Color =
                        ColorSequence.new(
                        {ColorSequenceKeypoint.new(0.00, color), ColorSequenceKeypoint.new(1.00, clr)}
                    )
            ...
            function sector:AddKeybind(text, default, newkeycallback, callback)
                ...
                keybind.Bind.MouseButton1Down:Connect(
                    function()
                        keybind.Bind.Text = "[...]"
                        keybind.Main.TextColor3 = window.theme.accentcolor
                    end
            ...
            function sector:AddDropdown(text, items, default, callback)
                ...
                dropdown.BlackOutline2.MouseEnter:Connect(
                    function()
                        dropdown.BlackOutline2.BackgroundColor3 = window.theme.accentcolor
                    end
                )
                dropdown.BlackOutline2.MouseLeave:Connect(
                    function()
                        dropdown.BlackOutline2.BackgroundColor3 = window.theme.outlinecolor2
                    end
                )
        ...
        function tab:CreatePlayerlist(name)
            ...
            list.Label.Size =
                UDim2.fromOffset(
                math.clamp(
                    textservice:GetTextSize(list.name, 13, window.theme.font, Vector2.new(200, 300)).X + 10,
                    0,
                    list.Main.Size.X.Offset
                ),
                size.Y
            )
            ...
            function list:AddPlayer(Player)
                ...
                list.Items.Size =
                    UDim2.fromOffset(list.Items.AbsoluteSize.X, math.clamp(list.Items.CanvasSize.Y.Offset, 0, 205))
                return player
            end
